package com.eamon.zhuiqiu.util.security.Impl;
...
public class Base64 implements CodeMethod{
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        System.out.println(Base64.getInstance().encode("熊Eamon"));
        System.out.println(
                new String(
                        Base64.getInstance().decode(
                                Base64.getInstance().encode("熊Eamon")), "UTF-8"));
    }
}
